...
inline const AsmList saveReplay =
{
    ...
    { ( void * ) 0x4830A4, {
        0xE8, INLINE_DWORD ( ( uintptr_t ) ( ( char * ) &saveReplayCb ) - 0x4830A4 - 5 ),   // call callback
...
inline const AsmList hijackLoadingStateColors =
{
    { ( void * ) 0x448202, {
        0x50,                                                                           // push eax
        0xE8, INLINE_DWORD ( ( uintptr_t ) ( ( char * ) &loadingStateColorCb ) - 0x448202 - 1 - 5 ),  // call loadingStateColorCb
        0x58,                                                                           // pop eax
...
inline const AsmList addExtraTextures =
{
    ...
    { ( void * ) 0x41BE38, {
         0xE8, INLINE_DWORD ( ( uintptr_t ) ( ( char * ) &addExtraTexturesCb ) - 0x41BE38 - 5 ),       // call addExtraTexturesCb
         0xC3
    } },
};
